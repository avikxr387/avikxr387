...
**Libraries & Tools:** NumPy, Pandas, Scikit-learn, TensorFlow, PyTorch, Matplotlib  
**Concepts:** Machine Learning, Deep Learning, NLP, Model Evaluation, Data Analysis  
...
- Learning deployment and production-level ML  

---

### Projects
- Hybrid RAG System (Document Retrieval + Hallucination Control)
- ScrollSense (Digital Well-being App)
- Stock Market Prediction Model
- Domain-Specific QnA Bot (Fine-tuning LLM)
